...
def post_github_comment(repo_full_name: str, pr_number: int, comment_body: str):
    ...
    """
    if not g:
        print("Error: PyGithub client not initialized (check GITHUB_TOKEN).")
        return
...
> **Note:** This review was generated by an AI model. Please verify these suggestions before committing any changes.

{comment_body}

---
<sub> Powered by Gemini 2.5 Flash • Code Review Automator</sub>
"""
